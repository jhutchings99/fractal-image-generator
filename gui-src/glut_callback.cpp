...
void keyboard_cb(unsigned char c, int x, int y) {
  ...
  case 'c':
    ...
    break;
  case 'X':
    g_app_data->createBurningShipFractal();
    break;
  case 'x':
    g_app_data->createBurningShipFractal2();
    break;
  case 'T':
  ...
  case '-':
    ...
    break;
  case '?':
    g_app_data->setMenuMode(GlutApp::M_MENU_TRUE);
    break;
  case '/':
    g_app_data->setMenuMode(GlutApp::M_MENU_FALSE);
    break;
  case '1':
